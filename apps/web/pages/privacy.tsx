...
export default function PrivacyPage() {
  return (
    <PublicPage
      ...
      documentTitle="Privacy Policy - MYXCROW"
      description="Privacy Policy for MYXCROW. How we collect, use and protect your data. Ghana Data Protection Act 2012 (Act 843). Web, Android and iOS."
    >
