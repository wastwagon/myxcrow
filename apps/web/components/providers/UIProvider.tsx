      ...
      {promptState?.open && (
        ...
        >
          ...
          <input
            ...
            className={light ? form.input : 'w-full min-h-[48px] px-4 py-3 rounded-[16px] bg-white/5 border border-white/20 text-label-primary placeholder:text-label-tertiary focus:ring-2 focus:ring-brand-gold focus:border-brand-gold/50 outline-none'}
            onKeyDown={(e) => {
