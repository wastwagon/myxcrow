...
export const admin = {
  ...
  input:
    'w-full px-3 py-2.5 border border-white/20 rounded-[12px] bg-white/5 text-white placeholder:text-white/45 focus:ring-2 focus:ring-brand-gold focus:border-brand-gold/50 outline-none',
  select:
    'w-full px-3 py-2.5 border border-white/20 rounded-[12px] bg-[#2a1c1e] text-white focus:ring-2 focus:ring-brand-gold focus:border-brand-gold/50 outline-none appearance-none',
  ...
  selectedUserCard:
    'flex items-center justify-between p-4 rounded-[12px] border border-brand-gold/30 bg-brand-gold/10',
  selectedUserCardDanger:
    'flex items-center justify-between p-4 rounded-[12px] border border-red-500/30 bg-red-500/10',
  searchDropdown:
    'absolute z-10 w-full mt-2 rounded-[12px] border border-white/15 bg-[#261819] shadow-lg max-h-64 overflow-y-auto',
  searchDropdownItem:
  ...
  rowAction:
    'inline-flex min-h-[44px] min-w-[44px] items-center justify-center rounded-[12px] transition-colors touch-manipulation',
  calloutInfo:
    'rounded-[12px] border border-white/15 bg-white/[0.08] p-4 text-left text-sm text-label-secondary',
  modalPanel:
