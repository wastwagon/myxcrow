...
export const admin = {
  ...
  panelPadded: 'rounded-ios-xl border border-white/10 bg-white/[0.07] backdrop-blur-sm shadow-ios-card p-4 md:p-5',
  ...
  input:
    'w-full px-3 py-2.5 border border-white/20 rounded-ios-lg bg-white/5 text-white placeholder:text-white/45 focus:ring-2 focus:ring-brand-gold focus:border-brand-gold/50 outline-none',
  select:
    'w-full px-3 py-2.5 border border-white/20 rounded-ios-lg bg-[#2a1c1e] text-white focus:ring-2 focus:ring-brand-gold focus:border-brand-gold/50 outline-none appearance-none',
  ...
  actionCard:
    'rounded-ios-xl border border-white/10 bg-white/[0.07] backdrop-blur-sm shadow-ios-card p-4 hover:bg-white/[0.1] hover:border-brand-gold/25 transition-all group block',
